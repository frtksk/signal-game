...
function RoleSelectScreen({selectedRole,setSelectedRole,onStart}){
  return (
    <div style={{...s.card,animation:"fadeIn .6s ease"}}>
      ...
      <p style={{...s.body,marginBottom:16}}>あなたはどの立場から信号に向き合いますか？</p>
...
const s = {
  ...
  card:{background:"rgba(8,20,50,.88)",border:"1px solid rgba(125,211,252,.18)",borderRadius:16,padding:"64px 24px",backdropFilter:"blur(12px)",boxShadow:"0 0 60px rgba(14,165,233,.08),0 4px 32px rgba(0,0,0,.5)",animation:"signalPulse 6s ease-in-out infinite"},
  ...
  roleSelectCard:{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",borderRadius:10,cursor:"pointer",textAlign:"left",background:"rgba(255,255,255,.03)",border:"1px solid rgba(125,211,252,.12)",position:"relative"},
  roleSelectCardActive:{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",borderRadius:10,cursor:"pointer",textAlign:"left",background:"rgba(14,165,233,.12)",border:"1px solid rgba(125,211,252,.55)",position:"relative"},
  roleSelectCardDisabled:{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",borderRadius:10,cursor:"not-allowed",textAlign:"left",background:"rgba(255,255,255,.01)",border:"1px solid rgba(125,211,252,.05)",position:"relative",opacity:.35},
  roleSelectIcon:{fontSize:18,flexShrink:0,width:24,textAlign:"center"},
  roleSelectName:{color:"#e8f0f8",fontSize:13,fontWeight:600,display:"block",marginBottom:2},
  roleSelectFilter:{color:"#b8c8da",fontSize:12,lineHeight:1.4,display:"block",textWrap:"pretty"},
  roleSelectFilterActive:{color:"#dde6f0",fontSize:12,lineHeight:1.4,display:"block",textWrap:"pretty"},
