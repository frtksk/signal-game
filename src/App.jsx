...
const s = {
  ...
  alienDesc:{color:"#dde6f0",fontSize:14,lineHeight:1.9,margin:"0 0 14px",wordBreak:"break-all"},
  alienHint:{color:"#e8f0f8",fontSize:13,lineHeight:1.7,margin:0,padding:"10px 14px",background:"rgba(255,255,255,.03)",borderRadius:8,borderLeft:"3px solid",wordBreak:"break-all"},
  // Final decision
